...
// Type: EmilandAtelye.Domain.ViewModels.ExpensesMIViewModel
...
public class ExpensesMIViewModel : BaseViewModel
{
  ...
  public ExpensesMIViewModel(IUnitOfWork unitOfWork)
  {
  ...
  {
    this.Expenses = new ObservableCollection<Expense>(await this._unitOfWork.ExpenseRepository.GetAllExpensesMI(this.StartDate, this.EndDate));
  }

  public async Task Search()
  {
    IEnumerable<Expense> expenses = await this._unitOfWork.ExpenseRepository.GetAllExpensesMI(this.StartDate, this.EndDate);

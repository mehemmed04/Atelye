...
// Type: EmilandAtelye.Domain.ViewModels.OrderMKViewModel
...
public class OrderMKViewModel : BaseViewModel
{
  ...
  {
    OrderMKViewModel orderMkViewModel1 = this;
    Goods goodsByBarCode = await orderMkViewModel1.UnitOfWork.GoodsRepository.GetGoodsByBarCode(orderMkViewModel1.BarCode);
    if (goodsByBarCode == null)
      return;
    OrderMKViewModel orderMkViewModel2 = orderMkViewModel1;
    ...
    orderMkViewModel2.Price = nullable1;
    OrderMKViewModel orderMkViewModel3 = orderMkViewModel1;
    ...
    orderMkViewModel3.LastPrice = nullable2;
  }
  ...
  private async Task LoadLeftData()
  {
    ...
    {
      OrderMKViewModel orderMkViewModel1 = this;
      OrderMKViewModel orderMkViewModel = orderMkViewModel1;
      OrderDto response = await orderMkViewModel1.OrderService.GetCustomerOrders(orderMkViewModel1.DepartmentId);
      IEnumerable<CustomersSummary> data = response.BaseLeftOrders;
      await Application.Current.Dispatcher.InvokeAsync((Action) (() => orderMkViewModel.LeftOrders = new ObservableCollection<CustomersSummary>(data)));
      orderMkViewModel1.LeftUsdAll = response.LeftUsdAll;
      orderMkViewModel1.LeftAznAll = response.LeftAznAll;
      orderMkViewModel1.LeftEuroAll = response.LeftEuroAll;
      orderMkViewModel1.LeftRubAll = response.LeftRubAll;
      orderMkViewModel1.LeftDebtAll = response.LeftDebtAll;
  ...
  public async Task AddOrder(object parametr)
  {
    ...
    if (orderMkViewModel1.SelectedCurrency == null)
    {
    ...
    {
      byte urgent = 0;
      if (orderMkViewModel1.IsChecked)
        urgent = (byte) 1;
      int num1;
      if (orderMkViewModel1.CustomerId.IsNullOrEmpty<char>())
      {
        int maxCustomerId = await orderMkViewModel1.UnitOfWork.CustomerRepository.GetMaxCustomerId();
        OrderMKViewModel orderMkViewModel2 = orderMkViewModel1;
        int num2;
        num1 = num2 = maxCustomerId + 1;
        string str = num1.ToString();
        orderMkViewModel2.CustomerId = str;
        if (!await orderMkViewModel1.AddCustomer())
        {
          int num3 = (int) MessageBox.Show("Müşt?ri ?lav? oluna bilm?di");
        }
      }
      double? beh1 = orderMkViewModel1.Beh;
      AddUpdateFinanceRequest updateFinanceRequest = new AddUpdateFinanceRequest();
      updateFinanceRequest.CustomerId = new int?(int.Parse(orderMkViewModel1.CustomerId));
      updateFinanceRequest.CusName = orderMkViewModel1.CustomerName;
      updateFinanceRequest.CusGsm = orderMkViewModel1.CustomerGsm;
      updateFinanceRequest.CusSurname = orderMkViewModel1.CustomerSurname;
      updateFinanceRequest.CusFatherName = orderMkViewModel1.Note;
      updateFinanceRequest.Barcode = orderMkViewModel1.BarCode;
      updateFinanceRequest.CusTelNo = orderMkViewModel1.CustomerTel;
      GroupGen2ForOrder selectedType1 = orderMkViewModel1.SelectedType;
      updateFinanceRequest.GroupGen2Id = new long?(selectedType1 != null ? (long) selectedType1.GroupGen2Id : 17001L);
      Tailor typeForMeasurment = orderMkViewModel1.SelectedTypeForMeasurment;
      ...
      double? price = orderMkViewModel1.Price;
      updateFinanceRequest.PriceTotal = price.HasValue ? new Decimal?((Decimal) price.GetValueOrDefault()) : new Decimal?();
      updateFinanceRequest.DepartId = new int?(orderMkViewModel1.DepartmentId);
      double? nullable = orderMkViewModel1.LastPrice;
      updateFinanceRequest.LastPriceTotal = nullable.HasValue ? new float?((float) nullable.GetValueOrDefault()) : new float?();
      nullable = orderMkViewModel1.Beh;
      updateFinanceRequest.PayedTotal = nullable.HasValue ? new float?((float) nullable.GetValueOrDefault()) : new float?();
      updateFinanceRequest.CurTypeId = new int?(orderMkViewModel1.SelectedCurrency.CurTypeId);
      updateFinanceRequest.RowDate = new DateTime?(orderMkViewModel1.DeliveryDate.Date);
      nullable = orderMkViewModel1.LastPrice;
      double? beh2 = orderMkViewModel1.Beh;
      ...
      updateFinanceRequest.Status = new byte?((byte) (orderMkViewModel1.SelectedTypeForMeasurment == null));
      ...
      flag = await orderMkViewModel1.UnitOfWork.FinanceRepository.AddFinanceAsync(order);
label_14:
      if (!flag)
      {
        order = (AddUpdateFinanceRequest) null;
      ...
      else
      {
        ...
        if (orderMkViewModel1.DepartmentId == 18)
        {
          OrderMKViewModel orderMkViewModel3 = orderMkViewModel1;
          AddUpdateFinanceRequest request = order;
          beh2 = orderMkViewModel1.Beh;
          float? payedTotal = beh2.HasValue ? new float?((float) beh2.GetValueOrDefault()) : new float?();
          int departmentId = orderMkViewModel1.DepartmentId;
          GroupGen2ForOrder selectedType2 = orderMkViewModel1.SelectedType;
          int groupgen2Id = selectedType2 != null ? selectedType2.GroupGen2Id : 12006;
          await orderMkViewModel3.ProcessCashBoxMI(request, payedTotal, departmentId, groupgen2Id);
        }
        if (orderMkViewModel1.DepartmentId == 12 || orderMkViewModel1.DepartmentId == 13 || orderMkViewModel1.DepartmentId == 14 || orderMkViewModel1.DepartmentId == 17)
        {
          OrderMKViewModel orderMkViewModel4 = orderMkViewModel1;
          AddUpdateFinanceRequest request = order;
          beh2 = orderMkViewModel1.Beh;
          float? payedTotal = beh2.HasValue ? new float?((float) beh2.GetValueOrDefault()) : new float?();
          int departmentId = orderMkViewModel1.DepartmentId;
          GroupGen2ForOrder selectedType3 = orderMkViewModel1.SelectedType;
          int groupgen2Id = selectedType3 != null ? selectedType3.GroupGen2Id : 12006;
          await orderMkViewModel4.ProcessCashBox(request, payedTotal, departmentId, groupgen2Id);
        }
        if (!orderMkViewModel1.IsSearchPage)
        {
          orderMkViewModel1.LoadRightFinanceDataToday(int.Parse(orderMkViewModel1.CustomerId));
          orderMkViewModel1.LoadLeftFinanceDataToday(int.Parse(orderMkViewModel1.CustomerId));
        }
        else
        {
          orderMkViewModel1.LoadLeftData();
          orderMkViewModel1.LoadRightData();
        }
        orderMkViewModel1.ClearInputs();
        order = (AddUpdateFinanceRequest) null;
      }
    }
  }
